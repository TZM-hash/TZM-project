...
public static class DataWorkbenchPresets
{
    ...
    public static DataWorkbenchViewModel Equipment => Create("equipment", "equipment-table", [("number", "编号"), ("name", "名称"), ("model", "型号"), ("ownership", "权属"), ("status", "状态"), ("notes", "备注摘要"), ("actions", "操作")]);
