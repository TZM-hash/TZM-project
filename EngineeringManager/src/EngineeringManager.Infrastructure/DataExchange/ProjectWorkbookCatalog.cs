...
public static class ProjectWorkbookCatalog
{
    ...
    [
        ...
        [
            ...
            Field("responsible_employee_ids", "负责人职员ID集合", ExportFieldDataType.Text),
            ...
            Field("responsible_employees", "项目负责人集合", ExportFieldDataType.Text, CanImport: false),
        ...
        [
            ...
            Field("quantity", "工程量", ExportFieldDataType.Number),
            Field("unit_price", "单价", ExportFieldDataType.Number),
            Field("accounting_label", "口径", ExportFieldDataType.Text),
            Field("requires_invoice", "是否开票", ExportFieldDataType.Boolean),
            Field("notes", "备注", ExportFieldDataType.Text),
            Technical("_system_id", "系统ID"), Technical("_project_system_id", "项目系统ID"),
        ...
        Define(ProjectWorkbookSheet.Receivables, "应收", false, false, [ProjectWorkbookSheet.ProjectMaster], FinanceFields(
        ...
        Define(ProjectWorkbookSheet.Collections, "收款", true, false, [ProjectWorkbookSheet.ProjectMaster], FinanceFields(
            [Field("receivable_id", "应收系统ID", ExportFieldDataType.Text), Field("collection_date", "收款日期", ExportFieldDataType.Date, true), Field("account_name", "收款账户", ExportFieldDataType.Text, CanImport: false), Field("account_id", "账户ID", ExportFieldDataType.Text, true), Field("amount", "收款金额", ExportFieldDataType.Number, true), Field("source_amount", "源记录总额", ExportFieldDataType.Number), Field("allocation_amount", "项目分摊金额", ExportFieldDataType.Number), Field("payment_method", "收款方式", ExportFieldDataType.Text, true), Field("notes", "备注", ExportFieldDataType.Text)])),
        ...
        Define(ProjectWorkbookSheet.Payments, "付款", true, false, [ProjectWorkbookSheet.Payables], FinanceFields(
            [Field("payable_id", "应付系统ID", ExportFieldDataType.Text), Field("payment_date", "付款日期", ExportFieldDataType.Date, true), Field("account_name", "付款账户", ExportFieldDataType.Text, CanImport: false), Field("account_id", "账户ID", ExportFieldDataType.Text, true), Field("amount", "金额", ExportFieldDataType.Number, true), Field("source_amount", "源记录总额", ExportFieldDataType.Number), Field("allocation_amount", "项目分摊金额", ExportFieldDataType.Number), Field("payment_method", "付款方式", ExportFieldDataType.Text, true), Field("notes", "备注", ExportFieldDataType.Text)])),
        Define(ProjectWorkbookSheet.Invoices, "发票", true, false, [ProjectWorkbookSheet.ProjectMaster], FinanceFields(
            [Field("invoice_number", "发票号码", ExportFieldDataType.Text, true), Field("invoice_date", "发票日期", ExportFieldDataType.Date, true), Field("invoice_type", "发票类型", ExportFieldDataType.Text), Field("project_tax_configuration_id", "项目税务配置ID", ExportFieldDataType.Text), Field("tax_rate", "税率", ExportFieldDataType.Number, true), Field("net_amount", "未税金额", ExportFieldDataType.Number, true), Field("tax_amount", "税额", ExportFieldDataType.Number, true), Field("gross_amount", "含税金额", ExportFieldDataType.Number, true), Field("source_amount", "源记录总额", ExportFieldDataType.Number), Field("allocation_amount", "项目分摊金额", ExportFieldDataType.Number), Field("settlement_id", "应收系统ID", ExportFieldDataType.Text), Field("status", "状态", ExportFieldDataType.Text, true)])),
