...
public static class DataWorkbenchPresets
{
    ...
    public static DataWorkbenchViewModel Partners => Create("partners", "partners-table", [("number", "编号"), ("name", "单位名称"), ("short_name", "简称"), ("roles", "角色"), ("trade", "专业/类别"), ("contact", "主要联系人"), ("phone", "联系人电话"), ("projects", "参与项目"), ("notes", "备注摘要"), ("status", "状态"), ("actions", "操作")]);
    ...
    public static DataWorkbenchViewModel CompanyCertificates => Create("company-certificates", "company-certificates-table", [("company", "公司"), ("certificate_type", "证书类型"), ("certificate_number", "证书编号"), ("scope", "专业/等级/范围"), ("authority", "发证机关"), ("issued_on", "签发日期"), ("expires_on", "到期日期"), ("status", "状态"), ("attachment", "附件"), ("actions", "操作")]);
    public static DataWorkbenchViewModel Equipment => Create("equipment", "equipment-table", [("equipment", "设备"), ("model_category", "型号 / 分类"), ("managing_company", "管理公司"), ("ownership", "权属"), ("status", "状态"), ("qualification", "合格证"), ("rate", "参考价"), ("actions", "操作")]);
    public static DataWorkbenchViewModel Crews => Create("crews", "crews-table", [("crew", "班组"), ("trade", "专业"), ("contact", "负责人"), ("workers", "当前人员"), ("projects", "参与项目"), ("paid", "累计代发工程款"), ("last_payment", "最近发放"), ("actions", "操作")]);
