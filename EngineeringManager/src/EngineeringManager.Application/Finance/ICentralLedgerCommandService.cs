...
public interface ICentralLedgerCommandService
{
    ...
    Task UpdateSettlementAsync(CentralLedgerActor actor, UpdateSettlementRequest request, CancellationToken token);
    ...
    Task UpdateInvoiceAsync(CentralLedgerActor actor, UpdateFinanceInvoiceRequest request, CancellationToken token);
    Task<Guid> CreateCashAsync(CentralLedgerActor actor, CreateFinanceCashRequest request, CancellationToken token);
    Task UpdateCashAsync(CentralLedgerActor actor, UpdateFinanceCashRequest request, CancellationToken token);
