...
namespace EngineeringManager.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260806071258_UnifiedPersonnelAndOrganizationOwnership")]
    partial class UnifiedPersonnelAndOrganizationOwnership
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EngineeringManager.Domain.Organization.OrganizationUnit", b =>
                {
                    ...
                    b.Property<bool>("IsAuthorizationScope")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("OrganizationUnits", t =>
                        {
                            t.HasCheckConstraint("CK_OrganizationUnits_Owner", "NOT ([LegalEntityId] IS NOT NULL AND [BusinessPartnerId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.Employee", b =>
                {
                    ...
                    b.Property<bool>("IsProjectResponsible")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.EmployeeWageEntry", b =>
                {
                    ...
                    b.Property<bool>("ExcludeFromWageCost")
                        .HasColumnType("bit");
                    ...
                    b.Property<Guid?>("SourcePersonalAdvanceBatchId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SourcePersonalAdvanceBatchId");

                    b.HasIndex("EmployeeId", "BusinessYearId", "EntryType");
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.Equipment", b =>
                {
                    ...
                    b.Property<Guid?>("ManagingLegalEntityId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("QualificationAttachmentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("QualificationCertificateNumber")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<DateOnly?>("QualificationExpiresOn")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("QualificationIssuedOn")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("ManagingLegalEntityId");

                    b.HasIndex("OwnerLegalEntityId");

                    b.HasIndex("QualificationAttachmentId");
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.EquipmentSettlement", b =>
                {
                    ...
                    b.HasIndex("FinanceSettlementId")
                        .IsUnique()
                        .HasFilter("[FinanceSettlementId] IS NOT NULL");
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.ImportBatch", b =>
                {
                    ...
                    b.Property<Guid?>("SourceExportTaskId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.PayrollBatch", b =>
                {
                    ...
                    b.Property<int>("DisbursementType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1);
                    ...
                    b.Property<Guid?>("RepaysPersonalAdvanceAccountId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RepaysPersonalAdvanceAccountId");
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.PayrollPayment", b =>
                {
                    ...
                    b.HasIndex("EmployeeId", "PaymentCategory");
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("IdentityNumberNormalized")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("IdentityNumberNormalized")
                        .IsUnique()
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.PersonnelEngagementHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PersonId", "StartDate", "IsPrimary");

                    b.ToTable("PersonnelEngagementHistories", t =>
                        {
                            t.HasCheckConstraint("CK_PersonnelEngagementHistory_Scope", "(([Scope] = 1 AND [InternalType] IS NOT NULL AND [ExternalType] IS NULL) OR ([Scope] = 2 AND [InternalType] IS NULL AND [ExternalType] IS NOT NULL)) AND NOT ([LegalEntityId] IS NOT NULL AND [BusinessPartnerId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.ProjectResponsibleEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProjectResponsibleEmployees");
                });
            ...
            modelBuilder.Entity("EngineeringManager.Domain.Organization.OrganizationUnit", b =>
                {
                    b.HasOne("EngineeringManager.Infrastructure.Data.BusinessPartner", null)
                        .WithMany()
                        .HasForeignKey("BusinessPartnerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EngineeringManager.Domain.Organization.LegalEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.ConstructionWorker", b =>
                {
                    b.HasOne("EngineeringManager.Infrastructure.Data.Person", "Person")
                        .WithOne("ConstructionWorker")
                        .HasForeignKey("EngineeringManager.Infrastructure.Data.ConstructionWorker", "PersonId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.Employee", b =>
                {
                    ...
                    b.HasOne("EngineeringManager.Infrastructure.Data.Person", "Person")
                        .WithOne("Employee")
                        .HasForeignKey("EngineeringManager.Infrastructure.Data.Employee", "PersonId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.EmployeeWageEntry", b =>
                {
                    ...
                    b.HasOne("EngineeringManager.Infrastructure.Data.PayrollBatch", "SourcePersonalAdvanceBatch")
                        .WithMany()
                        .HasForeignKey("SourcePersonalAdvanceBatchId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("SourcePersonalAdvanceBatch");
                });
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.Equipment", b =>
                {
                    ...
                    b.HasOne("EngineeringManager.Domain.Organization.LegalEntity", "ManagingLegalEntity")
                        .WithMany()
                        .HasForeignKey("ManagingLegalEntityId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("EngineeringManager.Infrastructure.Data.Attachment", "QualificationAttachment")
                        .WithMany()
                        .HasForeignKey("QualificationAttachmentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("LessorBusinessPartner");

                    b.Navigation("ManagingLegalEntity");

                    b.Navigation("OwnerLegalEntity");

                    b.Navigation("QualificationAttachment");
                });
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.FinancialAccount", b =>
                {
                    ...
                    b.HasOne("EngineeringManager.Infrastructure.Data.Employee", "OwnerEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.PayrollBatch", b =>
                {
                    ...
                    b.HasOne("EngineeringManager.Infrastructure.Data.FinancialAccount", "RepaysPersonalAdvanceAccount")
                        .WithMany()
                        .HasForeignKey("RepaysPersonalAdvanceAccountId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("RepaysPersonalAdvanceAccount");
                });
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.Project", b =>
                {
                    ...
                    b.HasOne("EngineeringManager.Infrastructure.Data.Employee", "ResponsibleEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.ProjectResponsibleEmployee", b =>
                {
                    ...
                    b.HasOne("EngineeringManager.Infrastructure.Data.Project", "Project")
                        .WithMany("ResponsibleEmployeeLinks")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.Person", b =>
                {
                    ...
                    b.Navigation("EngagementHistory");
                });
            ...
            modelBuilder.Entity("EngineeringManager.Infrastructure.Data.Project", b =>
                {
                    ...
                    b.Navigation("ResponsibleEmployeeLinks");
