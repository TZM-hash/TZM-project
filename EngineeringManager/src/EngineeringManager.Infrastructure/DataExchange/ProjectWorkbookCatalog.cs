...
public static class ProjectWorkbookCatalog
{
    ...
    [
        ...
        Define(ProjectWorkbookSheet.Invoices, "发票", true, false, [ProjectWorkbookSheet.ProjectMaster], FinanceFields(
            [Field("invoice_number", "发票号码", ExportFieldDataType.Text, true), Field("invoice_date", "发票日期", ExportFieldDataType.Date, true), Field("invoice_type", "发票类型", ExportFieldDataType.Text), Field("tax_rate", "税率", ExportFieldDataType.Number, true), Field("net_amount", "未税金额", ExportFieldDataType.Number, true), Field("tax_amount", "税额", ExportFieldDataType.Number, true), Field("gross_amount", "含税金额", ExportFieldDataType.Number, true), Field("source_amount", "源记录总额", ExportFieldDataType.Number), Field("allocation_amount", "项目分摊金额", ExportFieldDataType.Number), Field("settlement_id", "应收系统ID", ExportFieldDataType.Text), Field("status", "状态", ExportFieldDataType.Text, true)])),
