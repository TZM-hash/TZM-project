...
public static class ProjectWorkbookCatalog
{
    ...
    [
        ...
        Define(ProjectWorkbookSheet.Collections, "收款", true, false, [ProjectWorkbookSheet.ProjectMaster], FinanceFields(
            [Field("collection_date", "收款日期", ExportFieldDataType.Date, true), Field("account_name", "收款账户", ExportFieldDataType.Text, CanImport: false), Field("account_id", "账户ID", ExportFieldDataType.Text, true), Field("amount", "收款金额", ExportFieldDataType.Number, true), Field("payment_method", "收款方式", ExportFieldDataType.Text, true), Field("notes", "备注", ExportFieldDataType.Text)])),
